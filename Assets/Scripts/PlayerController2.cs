...
public class PlayerController2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerInput.actions.FindActionMap("Movement2").Enable();
    }
    ...
    public void TakeDamage(int damage)
    {
        ...
        UpdateHealthUI();
        Debug.Log("Player2 took damage! Current Health: " + currentHealth);
    ...
    private void Die()
    {
        ...
        {
            GameManager.Instance.GameOver("Player2");
        }
